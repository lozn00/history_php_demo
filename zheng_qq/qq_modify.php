...
{
$str="【附加完成】";
$sql="update `qqreg`set `qq`='$qq',`contents`='$con',`shuoming`='$adds' where `id`='$hid' limit 1";
}
...
附加：<input type="text" name="add">
yes0;
print <<< yes4
<br/><input type="submit" name="sub" value="修改">
</form>
yes4;
 }
 else
