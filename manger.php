...
END1;*/
$string="\" method=\"post\"><tr><td>条数:<input type=\"text\" name=\"limits\" maxlength=\"5\" size=\"2\"></td></tr><tr>";
$string.="<td>关键字:<input type=\"text\" name=\"keys\"></td></tr><tr><td><input type=\"submit\" name=\"subs\" value=\"搜索\"></td></tr></form>";
echo $string;
...
$w=" `title` like '%".$_POST['keys']."%'"." or `contents` like '%".$_POST['keys']."%'" ;//模糊搜索
...
<?php
 ...
 {echo "<tr><td>id错误或者密码错误或权限不够。<br><a href='admin.php'>重新登陆</a></td></tr>";}
}
else
{
echo "<meta http-equiv='refresh' content='3;url=admin.php'>";
echo "<tr><td>你还没有登录呢，即将跳转到<a href='admin.php'>登陆</a></td></tr>";
}
?>
</table>
